...
" CoC
let g:coc_global_extensions = ['coc-tsserver', 'coc-json', 'coc-git', 'coc-rust-analyzer', 'coc-solargraph', 'coc-sumneko-lua', 'coc-jest', 'coc-prettier', 'coc-html', 'coc-clojure', 'coc-diagnostic', 'coc-eslint']
